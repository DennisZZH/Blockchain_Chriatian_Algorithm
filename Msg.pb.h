...
class message_t PROTOBUF_FINAL :
 ...
 public:
  ...
  ::timestamp_t* unsafe_arena_release_timestamp();
...
class request_t PROTOBUF_FINAL :
...
inline void message_t::unsafe_arena_set_allocated_timestamp(
    ::timestamp_t* timestamp) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:message_t.timestamp)
}
...
inline ::timestamp_t* message_t::unsafe_arena_release_timestamp() {
...
inline ::timestamp_t* message_t::_internal_mutable_timestamp() {
  ...
  if (timestamp_ == nullptr) {
    auto* p = CreateMaybeMessage<::timestamp_t>(GetArena());
    timestamp_ = p;
  }
  return timestamp_;
}
